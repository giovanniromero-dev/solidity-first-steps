...
contract data_structures {
    ...
    Customer customer_1 = Customer(1, "Giovanni Romero", "contact@giovanniromero.dev");

    // Fixed-length array of uints
    uint256 [5] public fixed_list_uints = [1, 2, 3, 4, 5];

    // Dynamic array of uints
    uint256[] dynamic_list_uints;

    // Dynamic array of type Customer
    ...
    // Assign multiple numbers to a string key
